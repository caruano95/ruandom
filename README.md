...
garage.html         The Garage — cars I've owned
spotting.html       Car Spotting — cars spotted in the wild
concerts.html       Concerts — concert photos
404.html            Not-found page
favicon.svg         Lowercase "r" favicon
.nojekyll           Disables Jekyll on GitHub Pages
assets/
  css/style.css     All styles
  images/           Car, spotting, and concert photos
```
